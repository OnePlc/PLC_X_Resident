<?php
/**
 * ResidentControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Resident Module
 *
 * @category Test
 * @package Resident
...
namespace OnePlaceTest\Resident\Controller;

use OnePlace\Resident\Controller\ResidentController;
...
class ResidentControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/resident', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('resident');
        $this->assertControllerName(ResidentController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ResidentController');
        $this->assertMatchedRouteName('resident');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/resident/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('resident');
        $this->assertControllerName(ResidentController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ResidentController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/resident/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('resident');
        $this->assertControllerName(ResidentController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ResidentController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/resident/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('resident');
        $this->assertControllerName(ResidentController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ResidentController');
