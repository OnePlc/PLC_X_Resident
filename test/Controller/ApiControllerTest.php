...
use OnePlace\Resident\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/resident/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/resident/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('resident-api');
    }
}
