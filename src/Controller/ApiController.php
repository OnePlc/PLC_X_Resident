<?php
/**
 * ApiController.php - Resident Api Controller
 *
 * Main Controller for Resident Api
 *
 * @category Controller
 * @package Application
...
class ApiController extends CoreController {
    ...
    public function indexAction() {
        ...
        $aReturn = ['state'=>'success','message'=>'Welcome to onePlace Resident API'];
    ...
    /**
     * List all Entities of Residents
     *
     * @return bool - no View File
     * @since 1.0.0
     */
    public function listAction() {
        ...
        # Get All Resident Entities from Database
    ...
    /**
     * Get a single Entity of Resident
     *
     * @return bool - no View File
     * @since 1.0.0
     */
    public function getAction() {
        ...
        try {
            ...
            $aReturn = ['state'=>'error','message'=>'Resident not found','oItem'=>[]];
            echo json_encode($aReturn);
            return false;
        }

        # Print Entity
        $aReturn = ['state'=>'success','message'=>'Resident found','oItem'=>$oItem];
        echo json_encode($aReturn);
